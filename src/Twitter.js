...
class Twitter extends Component {
  ...
  twitterShare() {
    let twitterShareUrl = `https://twitter.com/intent/tweet?text=My%20Magento-based%20business%20should%20be%20named%20${this.props.phrase}!%20Find%20yours%20at%20&url=${window.location.origin}`;
